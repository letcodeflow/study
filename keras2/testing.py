...
....
#2. 모델
def build_model(drop=0.5, optimizer=adam_v2.Adam, activation = 'relu', learning_rate=0.001, node1=512, node2=256, node3=128):
...
def create_hyperparameters():
    ...
    optimizers = [adam_v2.Adam,adadelta_v2.Adadelta]
    dropout = [0.3, 0.4, 0.5]
