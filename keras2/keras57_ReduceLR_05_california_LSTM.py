...
reduce_lr = ReduceLROnPlateau(mode='min',monitor='val_loss',verbose=1,patience=14,factor=0.0005)
model.compile(loss = 'mse', optimizer='adam')
model.fit(x_train, y_train, epochs=1, batch_size=200, validation_split=0.01,callbacks=[reduce_lr])
