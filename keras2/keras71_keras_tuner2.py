...
reduce_lr = ReduceLROnPlateau(monitor='val_loss', patience=5, mode='auto', verbose=0, factor=0.5)



model = kerastuner.hypermodel.build(best_hp)
history = model.fit(x_train, y_train, validation_split=0.2, epochs=300, callbacks=[es, reduce_lr])
