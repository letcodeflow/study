...
train = CIFAR10(path, train=True, download=True, transform=transf)
test = CIFAR10(path, train=False, download=True, transform=transf)
...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.flatten_1 = nn.Linear(32*5*5, 100)
